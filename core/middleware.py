...
class UserRestrictionMiddleware:
    ...
    Client routes (/client/) require authentication; role check is performed inside each view.
    """
    ...
    def __call__(self, request):
        ...
        # Client Route Protection — require login (role check handled inside views)
